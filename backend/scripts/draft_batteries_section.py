"""Draft Batteries & Energy Stage 4 section for Outremer / Supernova.

Usage (from backend/):
  python scripts/draft_batteries_section.py
"""
...
OUT_JSON = OUT_DIR / "batteries_section_draft_v4.json"
OUT_MD = OUT_DIR / "batteries_section_draft_v4.md"
OUT_INPUTS = OUT_DIR / "batteries_section_inputs.json"
...
def main() -> int:
    ...
    expect_path = (
        _BACKEND / "tests" / "fixtures" / "batteries_section_v4_expectations.json"
    )
    ...
    payload = {
        ...
        "dropped_wisdom_candidates": composed.get("dropped_wisdom_candidates"),

"""Draft Navigation & helm Stage 4 section for Outremer / Supernova.

Usage (from backend/):
  python scripts/draft_nav_section.py
"""
...
OUT_JSON = OUT_DIR / "nav_section_draft_v4.json"
OUT_MD = OUT_DIR / "nav_section_draft_v4.md"
OUT_INPUTS = OUT_DIR / "nav_section_inputs.json"
...
def main() -> int:
    ...
    expect_path = (
        _BACKEND / "tests" / "fixtures" / "nav_section_v4_expectations.json"
    )
    ...
    payload = {
        "section": "nav",
        "version": composed.get("version") or "v4.37",

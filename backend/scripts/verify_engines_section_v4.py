...
EXPECT = _BACKEND / "tests" / "fixtures" / "engines_section_v4_expectations.json"
...
def main() -> int:
    ...
    if got != exp:
        failures.append(f"engines inputs mismatch got={got} expected={exp}")
    else:
        print("OK — engines input set matches fixture")

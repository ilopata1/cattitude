...
/** Rolling means of TWA / TWS / polar % over a Polar window. */
export interface PolarWindowAverages {
  twaDeg: number | null;
  twsKnots: number | null;
...
export type PolarWindowSet = Record<PolarWindowMinutes, PolarWindowAverages>;
